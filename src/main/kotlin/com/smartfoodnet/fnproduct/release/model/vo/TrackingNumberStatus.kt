...
enum class TrackingNumberStatus(val description: String, val uploadType: OrderUploadType?) {
    NONE("송장없음", null),
    ...
    companion object {
        ...
        fun getInitialStatus(uploadType: OrderUploadType): TrackingNumberStatus {
            return INITIAL_STATUSES.firstOrNull { it.uploadType == uploadType }
                ?: throw IllegalArgumentException("Initial TrackingNumberStatus 을 찾을 수 없습니다")
        }
    }
}
