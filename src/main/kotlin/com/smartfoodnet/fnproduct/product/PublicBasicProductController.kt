...
@Api(description = "기본상품 관련 API", tags = ["Public API"])
@RestController
@RequestMapping("public/basic-products")
class PublicBasicProductController(private val basicProductService: BasicProductService) {
