...
data class BasicProductCreateModel(
    ...
    var basicProductCategory: BasicProductCategoryCreateModel?,

    @ApiModelProperty(value = "부자재카테고리")
    var subsidiaryMaterialCategory: SubsidiaryMaterialCategoryCreateModel?,
    ...
    var warehouse: WarehouseCreateModel,
